...
public class MultiRelationalDisplayFieldEntityResource {
    ...
    @Timed
    public ResponseEntity<MultiRelationalDisplayFieldEntity> createMultiRelationalDisplayFieldEntity(@RequestBody MultiRelationalDisplayFieldEntity multiRelationalDisplayFieldEntity) throws URISyntaxException {
    ...
    @RequestMapping(value = "/multiRelationalDisplayFieldEntitys",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<MultiRelationalDisplayFieldEntity> updateMultiRelationalDisplayFieldEntity(@RequestBody MultiRelationalDisplayFieldEntity multiRelationalDisplayFieldEntity) throws URISyntaxException {
        log.debug("REST request to update MultiRelationalDisplayFieldEntity : {}", multiRelationalDisplayFieldEntity);
        if (multiRelationalDisplayFieldEntity.getId() == null) {
            return createMultiRelationalDisplayFieldEntity(multiRelationalDisplayFieldEntity);
        }
        MultiRelationalDisplayFieldEntity result = multiRelationalDisplayFieldEntityRepository.save(multiRelationalDisplayFieldEntity);
    ...
    @RequestMapping(value = "/multiRelationalDisplayFieldEntitys",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<MultiRelationalDisplayFieldEntity>> getAllMultiRelationalDisplayFieldEntitys(Pageable pageable)
        throws URISyntaxException {
        Page<MultiRelationalDisplayFieldEntity> page = multiRelationalDisplayFieldEntityRepository.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/multiRelationalDisplayFieldEntitys");
    ...
    @RequestMapping(value = "/multiRelationalDisplayFieldEntitys/{id}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<MultiRelationalDisplayFieldEntity> getMultiRelationalDisplayFieldEntity(@PathVariable Long id) {
    ...
    @RequestMapping(value = "/multiRelationalDisplayFieldEntitys/{id}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Void> deleteMultiRelationalDisplayFieldEntity(@PathVariable Long id) {
