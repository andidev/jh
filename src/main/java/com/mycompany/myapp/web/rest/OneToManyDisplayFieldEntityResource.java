...
public class OneToManyDisplayFieldEntityResource {
    ...
    @RequestMapping(value = "/oneToManyDisplayFieldEntitys",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<OneToManyDisplayFieldEntity> getAll() {
        log.debug("REST request to get all OneToManyDisplayFieldEntitys");
        return oneToManyDisplayFieldEntityRepository.findAll();
    }
