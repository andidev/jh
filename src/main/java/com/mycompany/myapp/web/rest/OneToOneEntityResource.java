...
public class OneToOneEntityResource {
    ...
    @Timed
    public ResponseEntity<OneToOneEntity> createOneToOneEntity(@RequestBody OneToOneEntity oneToOneEntity) throws URISyntaxException {
    ...
    @RequestMapping(value = "/oneToOneEntitys",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<OneToOneEntity> updateOneToOneEntity(@RequestBody OneToOneEntity oneToOneEntity) throws URISyntaxException {
        log.debug("REST request to update OneToOneEntity : {}", oneToOneEntity);
        if (oneToOneEntity.getId() == null) {
            return createOneToOneEntity(oneToOneEntity);
        }
        OneToOneEntity result = oneToOneEntityRepository.save(oneToOneEntity);
    ...
    @RequestMapping(value = "/oneToOneEntitys",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<OneToOneEntity>> getAllOneToOneEntitys(Pageable pageable, @RequestParam(required = false) String filter)
        ...
        Page<OneToOneEntity> page = oneToOneEntityRepository.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/oneToOneEntitys");
    ...
    @RequestMapping(value = "/oneToOneEntitys/{id}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<OneToOneEntity> getOneToOneEntity(@PathVariable Long id) {
    ...
    @RequestMapping(value = "/oneToOneEntitys/{id}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Void> deleteOneToOneEntity(@PathVariable Long id) {
