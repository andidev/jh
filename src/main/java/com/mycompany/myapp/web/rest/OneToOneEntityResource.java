...
public class OneToOneEntityResource {
    ...
    @RequestMapping(value = "/oneToOneEntitys",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<OneToOneEntity> getAll(@RequestParam(required = false) String filter) {
        ...
        log.debug("REST request to get all OneToOneEntitys");
        return oneToOneEntityRepository.findAll();
    }
