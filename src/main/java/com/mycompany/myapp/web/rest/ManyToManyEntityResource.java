...
public class ManyToManyEntityResource {
    ...
    @Timed
    public ResponseEntity<ManyToManyEntity> createManyToManyEntity(@RequestBody ManyToManyEntity manyToManyEntity) throws URISyntaxException {
    ...
    @RequestMapping(value = "/manyToManyEntitys",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<ManyToManyEntity> updateManyToManyEntity(@RequestBody ManyToManyEntity manyToManyEntity) throws URISyntaxException {
        log.debug("REST request to update ManyToManyEntity : {}", manyToManyEntity);
        if (manyToManyEntity.getId() == null) {
            return createManyToManyEntity(manyToManyEntity);
        }
        ManyToManyEntity result = manyToManyEntityRepository.save(manyToManyEntity);
    ...
    @RequestMapping(value = "/manyToManyEntitys",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<ManyToManyEntity>> getAllManyToManyEntitys(Pageable pageable)
        throws URISyntaxException {
        Page<ManyToManyEntity> page = manyToManyEntityRepository.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/manyToManyEntitys");
    ...
    @RequestMapping(value = "/manyToManyEntitys/{id}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<ManyToManyEntity> getManyToManyEntity(@PathVariable Long id) {
    ...
    @RequestMapping(value = "/manyToManyEntitys/{id}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Void> deleteManyToManyEntity(@PathVariable Long id) {
