...
public class OneToManyEntityResource {
    ...
    @Timed
    public ResponseEntity<OneToManyEntity> createOneToManyEntity(@RequestBody OneToManyEntity oneToManyEntity) throws URISyntaxException {
    ...
    @RequestMapping(value = "/oneToManyEntitys",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<OneToManyEntity> updateOneToManyEntity(@RequestBody OneToManyEntity oneToManyEntity) throws URISyntaxException {
        log.debug("REST request to update OneToManyEntity : {}", oneToManyEntity);
        if (oneToManyEntity.getId() == null) {
            return createOneToManyEntity(oneToManyEntity);
        }
        OneToManyEntity result = oneToManyEntityRepository.save(oneToManyEntity);
    ...
    @RequestMapping(value = "/oneToManyEntitys",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<OneToManyEntity>> getAllOneToManyEntitys(Pageable pageable)
        throws URISyntaxException {
        Page<OneToManyEntity> page = oneToManyEntityRepository.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/oneToManyEntitys");
    ...
    @RequestMapping(value = "/oneToManyEntitys/{id}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<OneToManyEntity> getOneToManyEntity(@PathVariable Long id) {
    ...
    @RequestMapping(value = "/oneToManyEntitys/{id}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Void> deleteOneToManyEntity(@PathVariable Long id) {
