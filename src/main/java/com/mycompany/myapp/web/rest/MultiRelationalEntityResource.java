...
public class MultiRelationalEntityResource {
    ...
    @Timed
    public ResponseEntity<MultiRelationalEntity> createMultiRelationalEntity(@RequestBody MultiRelationalEntity multiRelationalEntity) throws URISyntaxException {
    ...
    @RequestMapping(value = "/multiRelationalEntitys",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<MultiRelationalEntity> updateMultiRelationalEntity(@RequestBody MultiRelationalEntity multiRelationalEntity) throws URISyntaxException {
        log.debug("REST request to update MultiRelationalEntity : {}", multiRelationalEntity);
        if (multiRelationalEntity.getId() == null) {
            return createMultiRelationalEntity(multiRelationalEntity);
        }
        MultiRelationalEntity result = multiRelationalEntityRepository.save(multiRelationalEntity);
    ...
    @RequestMapping(value = "/multiRelationalEntitys",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<MultiRelationalEntity>> getAllMultiRelationalEntitys(Pageable pageable)
        throws URISyntaxException {
        Page<MultiRelationalEntity> page = multiRelationalEntityRepository.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/multiRelationalEntitys");
    ...
    @RequestMapping(value = "/multiRelationalEntitys/{id}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<MultiRelationalEntity> getMultiRelationalEntity(@PathVariable Long id) {
    ...
    @RequestMapping(value = "/multiRelationalEntitys/{id}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Void> deleteMultiRelationalEntity(@PathVariable Long id) {
