...
public class MultiRelationalEntityResource {
    ...
    @RequestMapping(value = "/multiRelationalEntitys",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<MultiRelationalEntity> getAll() {
        log.debug("REST request to get all MultiRelationalEntitys");
        return multiRelationalEntityRepository.findAllWithEagerRelationships();
    }
