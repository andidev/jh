...
public class ManyToManyDisplayFieldEntityResource {
    ...
    @RequestMapping(value = "/manyToManyDisplayFieldEntitys",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<ManyToManyDisplayFieldEntity> getAll() {
        log.debug("REST request to get all ManyToManyDisplayFieldEntitys");
        return manyToManyDisplayFieldEntityRepository.findAll();
    }
