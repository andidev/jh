...
public class ManyToManyDisplayFieldEntityResource {
    ...
    @Timed
    public ResponseEntity<ManyToManyDisplayFieldEntity> createManyToManyDisplayFieldEntity(@RequestBody ManyToManyDisplayFieldEntity manyToManyDisplayFieldEntity) throws URISyntaxException {
    ...
    @RequestMapping(value = "/manyToManyDisplayFieldEntitys",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<ManyToManyDisplayFieldEntity> updateManyToManyDisplayFieldEntity(@RequestBody ManyToManyDisplayFieldEntity manyToManyDisplayFieldEntity) throws URISyntaxException {
        log.debug("REST request to update ManyToManyDisplayFieldEntity : {}", manyToManyDisplayFieldEntity);
        if (manyToManyDisplayFieldEntity.getId() == null) {
            return createManyToManyDisplayFieldEntity(manyToManyDisplayFieldEntity);
        }
        ManyToManyDisplayFieldEntity result = manyToManyDisplayFieldEntityRepository.save(manyToManyDisplayFieldEntity);
    ...
    @RequestMapping(value = "/manyToManyDisplayFieldEntitys",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<ManyToManyDisplayFieldEntity>> getAllManyToManyDisplayFieldEntitys(Pageable pageable)
        throws URISyntaxException {
        Page<ManyToManyDisplayFieldEntity> page = manyToManyDisplayFieldEntityRepository.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/manyToManyDisplayFieldEntitys");
    ...
    @RequestMapping(value = "/manyToManyDisplayFieldEntitys/{id}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<ManyToManyDisplayFieldEntity> getManyToManyDisplayFieldEntity(@PathVariable Long id) {
    ...
    @RequestMapping(value = "/manyToManyDisplayFieldEntitys/{id}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Void> deleteManyToManyDisplayFieldEntity(@PathVariable Long id) {
