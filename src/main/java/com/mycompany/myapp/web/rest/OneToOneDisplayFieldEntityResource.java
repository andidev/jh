...
import com.mycompany.myapp.web.rest.mapper.OneToOneDisplayFieldEntityMapper;
...
public class OneToOneDisplayFieldEntityResource {
    ...
    @Inject
    private OneToOneDisplayFieldEntityMapper oneToOneDisplayFieldEntityMapper;
    ...
    @Timed
    public ResponseEntity<OneToOneDisplayFieldEntityDTO> create(@RequestBody OneToOneDisplayFieldEntityDTO oneToOneDisplayFieldEntityDTO) throws URISyntaxException {
        log.debug("REST request to save OneToOneDisplayFieldEntity : {}", oneToOneDisplayFieldEntityDTO);
        if (oneToOneDisplayFieldEntityDTO.getId() != null) {
            return ResponseEntity.badRequest().header("Failure", "A new oneToOneDisplayFieldEntity cannot already have an ID").body(null);
        }
        OneToOneDisplayFieldEntity oneToOneDisplayFieldEntity = oneToOneDisplayFieldEntityMapper.oneToOneDisplayFieldEntityDTOToOneToOneDisplayFieldEntity(oneToOneDisplayFieldEntityDTO);
        ...
        return ResponseEntity.created(new URI("/api/oneToOneDisplayFieldEntitys/" + result.getId()))
                ...
                .body(oneToOneDisplayFieldEntityMapper.oneToOneDisplayFieldEntityToOneToOneDisplayFieldEntityDTO(result));
    }
    ...
    @RequestMapping(value = "/oneToOneDisplayFieldEntitys",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<OneToOneDisplayFieldEntityDTO> update(@RequestBody OneToOneDisplayFieldEntityDTO oneToOneDisplayFieldEntityDTO) throws URISyntaxException {
        log.debug("REST request to update OneToOneDisplayFieldEntity : {}", oneToOneDisplayFieldEntityDTO);
        if (oneToOneDisplayFieldEntityDTO.getId() == null) {
            return create(oneToOneDisplayFieldEntityDTO);
        }
        OneToOneDisplayFieldEntity oneToOneDisplayFieldEntity = oneToOneDisplayFieldEntityMapper.oneToOneDisplayFieldEntityDTOToOneToOneDisplayFieldEntity(oneToOneDisplayFieldEntityDTO);
        OneToOneDisplayFieldEntity result = oneToOneDisplayFieldEntityRepository.save(oneToOneDisplayFieldEntity);
        return ResponseEntity.ok()
                .headers(HeaderUtil.createEntityUpdateAlert("oneToOneDisplayFieldEntity", oneToOneDisplayFieldEntityDTO.getId().toString()))
                .body(oneToOneDisplayFieldEntityMapper.oneToOneDisplayFieldEntityToOneToOneDisplayFieldEntityDTO(result));
    }
    ...
    public ResponseEntity<List<OneToOneDisplayFieldEntityDTO>> getAll(@RequestParam(value = "page" , required = false) Integer offset,
        ...
        if ("multirelationaldisplayfieldentity-is-null".equals(filter)) {
            ...
            return new ResponseEntity<>(StreamSupport
                ...
                .map(oneToOneDisplayFieldEntity -> oneToOneDisplayFieldEntityMapper.oneToOneDisplayFieldEntityToOneToOneDisplayFieldEntityDTO(oneToOneDisplayFieldEntity))
                .collect(Collectors.toList()), HttpStatus.OK);
        }
        
        Page<OneToOneDisplayFieldEntity> page = oneToOneDisplayFieldEntityRepository.findAll(PaginationUtil.generatePageRequest(offset, limit));
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/oneToOneDisplayFieldEntitys", offset, limit);
        return new ResponseEntity<>(page.getContent().stream()
            .map(oneToOneDisplayFieldEntityMapper::oneToOneDisplayFieldEntityToOneToOneDisplayFieldEntityDTO)
    ...
    @RequestMapping(value = "/oneToOneDisplayFieldEntitys/{id}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<OneToOneDisplayFieldEntityDTO> get(@PathVariable Long id) {
        ...
        return Optional.ofNullable(oneToOneDisplayFieldEntityRepository.findOne(id))
            .map(oneToOneDisplayFieldEntityMapper::oneToOneDisplayFieldEntityToOneToOneDisplayFieldEntityDTO)
            .map(oneToOneDisplayFieldEntityDTO -> new ResponseEntity<>(
                oneToOneDisplayFieldEntityDTO,
                HttpStatus.OK))
