...
public class OneToOneDisplayFieldEntityResource {
    ...
    @RequestMapping(value = "/oneToOneDisplayFieldEntitys",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<OneToOneDisplayFieldEntity> getAll(@RequestParam(required = false) String filter) {
        ...
        log.debug("REST request to get all OneToOneDisplayFieldEntitys");
        return oneToOneDisplayFieldEntityRepository.findAll();
    }
