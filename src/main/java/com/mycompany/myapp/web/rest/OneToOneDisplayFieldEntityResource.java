...
public class OneToOneDisplayFieldEntityResource {
    ...
    @Timed
    public ResponseEntity<OneToOneDisplayFieldEntity> create(@RequestBody OneToOneDisplayFieldEntity oneToOneDisplayFieldEntity) throws URISyntaxException {
    ...
    @RequestMapping(value = "/oneToOneDisplayFieldEntitys",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<OneToOneDisplayFieldEntity> update(@RequestBody OneToOneDisplayFieldEntity oneToOneDisplayFieldEntity) throws URISyntaxException {
        log.debug("REST request to update OneToOneDisplayFieldEntity : {}", oneToOneDisplayFieldEntity);
        if (oneToOneDisplayFieldEntity.getId() == null) {
            return create(oneToOneDisplayFieldEntity);
        }
        OneToOneDisplayFieldEntity result = oneToOneDisplayFieldEntityRepository.save(oneToOneDisplayFieldEntity);
    ...
    @RequestMapping(value = "/oneToOneDisplayFieldEntitys",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<List<OneToOneDisplayFieldEntity>> getAll(@RequestParam(value = "page" , required = false) Integer offset,
    ...
    @RequestMapping(value = "/oneToOneDisplayFieldEntitys/{id}",
            ...
            produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<OneToOneDisplayFieldEntity> get(@PathVariable Long id) {
