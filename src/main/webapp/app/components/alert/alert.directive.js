                ...
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('jhApp.httpError', function (event, httpResponse) {
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-jhApp-error');
                                var entityKey = httpResponse.headers('X-jhApp-params');
                                if (errorHeader) {
                                    ...
                                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                                        ...
                                        var fieldName = $translate.instant('jhApp.' + fieldError.objectName + '.' + convertedField);
